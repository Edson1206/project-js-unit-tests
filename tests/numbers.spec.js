...
describe('2 - Implemente os casos de teste para a função `numbers`', () => {
  ...
  it('Verifica se a função `numbers` retorna `false` quando o array contém uma letra', () => {
    expect(numbers([1, 'a', 3])).toBe(false);
  });
  it('Verifica se a função `numbers` retorna `false` quando o array contém um número em forma de string', () => {
    expect(numbers([[1, 2, '3', 4, 5]])).toBe(false);
  });
  it('Verifica se a função `numbers` retorna `false` quando um array vazio é informado', () => {
